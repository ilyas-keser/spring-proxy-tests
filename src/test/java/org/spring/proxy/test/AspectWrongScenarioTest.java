 ...
 * Aspekt und ist nicht über einen ScopedProxy geschützt.
 * 
...
@ContextConfiguration(classes = AspectWrongScenarioTest.TestConfiguration.class)
public class AspectWrongScenarioTest extends BaseTest {
