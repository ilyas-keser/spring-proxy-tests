...
@ContextConfiguration(classes = SpringNoProxyWithAspectInThreadScopeTest.TestConfiguration.class)
public class SpringNoProxyWithAspectInThreadScopeTest {
    ...
    public void testSharingSameInstanceIfWithoutScopedProxy() {
        ...
        assertEquals(runnable1.getDoSomething(), runnable2.getDoSomething());
    ...
    public static class TestConfiguration {
        ...
        @Scope(value = "thread")
        @Bean
        public ThreadIdAspect createTestAspect() {
            return new ThreadIdAspect();
        }
